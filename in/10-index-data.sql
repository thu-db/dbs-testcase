...
SELECT L_PARTKEY, L_SUPPKEY, L_ORDERKEY, L_LINENUMBER, L_COMMENT FROM LINEITEM WHERE LINEITEM.L_PARTKEY < 10 AND LINEITEM.L_COMMENT >= 'y';
SELECT L_PARTKEY, L_SUPPKEY, L_ORDERKEY, L_LINENUMBER, L_COMMENT FROM LINEITEM WHERE LINEITEM.L_PARTKEY < 20 AND LINEITEM.L_COMMENT >= 'y';
SELECT L_PARTKEY, L_SUPPKEY, L_ORDERKEY, L_LINENUMBER, L_COMMENT FROM LINEITEM WHERE LINEITEM.L_PARTKEY < 10 AND LINEITEM.L_COMMENT >= 'x';
SELECT L_PARTKEY, L_SUPPKEY, L_ORDERKEY, L_LINENUMBER, L_COMMENT FROM LINEITEM WHERE LINEITEM.L_PARTKEY < 100 AND LINEITEM.L_PARTKEY >= 80 AND LINEITEM.L_COMMENT <= 'c';
SELECT L_PARTKEY, L_SUPPKEY, L_ORDERKEY, L_LINENUMBER, L_COMMENT FROM LINEITEM WHERE LINEITEM.L_PARTKEY < 10 AND LINEITEM.L_COMMENT <= 'b';
