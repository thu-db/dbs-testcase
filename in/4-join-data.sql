...
SELECT CUSTOMER.C_NAME, SUPPLIER.S_NAME FROM CUSTOMER, SUPPLIER WHERE CUSTOMER.C_NATIONKEY = SUPPLIER.S_NATIONKEY AND CUSTOMER.C_ACCTBAL < -999.0 AND SUPPLIER.S_ACCTBAL < -888.0;
