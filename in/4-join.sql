...
SELECT * FROM TBL7, TBL8 WHERE TBL7.a = TBL8.a;
SELECT * FROM TBL7, TBL8 WHERE TBL7.b = TBL8.b;
SELECT * FROM TBL7, TBL8 WHERE TBL7.a = TBL8.a AND TBL7.c < 3.1;
SELECT * FROM TBL7, TBL8 WHERE TBL7.a = TBL8.a AND TBL8.c < 3.1 AND TBL7.b = '3';
SELECT * FROM TBL7, TBL8 WHERE TBL7.a = TBL8.a AND TBL7.c < 4.1 AND TBL7.b = '3' AND TBL8.b <> '4';
